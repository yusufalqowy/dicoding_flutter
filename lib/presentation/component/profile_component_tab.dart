...
class ProfileTab extends StatelessWidget {
  ...
  const ProfileTab({super.key, required this.listPortofolio});
      ...
      child: Column(
        children: [
            ...
            children: [
              ...
              Expanded(
                ...
                child: Column(
                  children: [
                    Text.rich(
                      const TextSpan(text: "My name is ", children: [
                        TextSpan(
                          text: "Muhammad Yusuf Alqowy",
                          style: TextStyle(
                    ...
                    child: Column(
                      ...
                      children: [
                        MySkill(
                            ...
                            level: "Beginner"),
                        MySkill(
                            title: "Flutter", progress: 40, level: "Beginner"),
                        MySkill(
                            title: "Laravel",
                            progress: 50,
                            level: "Advanced Beginner"),
          ...
          DynamicHeightGridView(
            ...
            builder: (ctx, index) {
              var data = listPortofolio[index];
              return PortofolioView(data: data);
            },
          ),
          const SizedBox(
            height: 8,
